...
void main() {
  ...
  test('listSavedIds and listSavedProfiles round-trip every saved profile',
      () async {
  ...
  test('deleteProfile removes it and leaves other saves and current intact',
      () async {
  ...
  test(
      'deleteProfile also clears the current pointer when deleting the '
  ...
  test('deleteProfile clears the last-used pointer too, when it matches',
      () async {
    await repository.setCurrent(_profile('a', 'Anna'));
    await repository.clearCurrent();

...
void main() {
  ...
  test(
      'the day streak extends on consecutive days and resets after a '
      'skipped day', () async {
    final controller = LearnerController();
    await controller.createAndSave(name: 'Anna', grade: 1, energy: 60);
  ...
  test(
      'energy regenerates 10 every 4 hours after a drain, capped at the '
    ...
    expect(
      controller.profile!
          .effectiveEnergy(day1.add(const Duration(hours: 12))),
      100,
    );
  });
}

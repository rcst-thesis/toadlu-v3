...
void main() {
  ...
  int readParentGateAnswer(WidgetTester tester) {
    final questionText =
        tester.widgetList<Text>(find.textContaining('What is')).single.data!;
  ...
  testWidgets(
      'Expanding General on a short viewport scrolls instead of '
  ...
  testWidgets(
      "Sound & Voice expands in place to reveal Master Volume and the "
  ...
  testWidgets(
      'Learning & Energy is dimmed and inert from the main menu (not '
  ...
  testWidgets(
    ...
    await tester.pumpWidget(
      const MaterialApp(
        home: SettingsScreen(insideLearnerProfile: true),
      ),
    );
  ...
  testWidgets('Toggling Lesson Reminders flips the switch', (tester) async {
    ...
    bool toggleValue() {
      final toggle = find.byKey(
        const Key('settings-lesson-reminders-toggle'),
      );
  ...
  testWidgets(
      'Reset Lesson Progress asks for the parent gate before the reset '
  ...
  testWidgets(
      ...
      'the reset confirmation', (tester) async {
    setViewport(tester);
    await tester.pumpWidget(
      const MaterialApp(
        home: SettingsScreen(insideLearnerProfile: true),
  ...
  testWidgets(
      'A correct parent gate answer opens the energy editor pre-filled '
  ...
  testWidgets(
      'Saving a new energy level in the editor persists it and updates '
  ...
  testWidgets(
      'Display & Performance expands in place to reveal the animation '
  ...
  testWidgets(
      'A device-wide setting survives closing and reopening Settings '
  ...
  testWidgets(
      ...
      'copy the main menu reads', (tester) async {
    setViewport(tester);
    final appSettings = AppSettingsController();
  ...
  testWidgets(
      'Expanding About (the last, bottom-most panel) scrolls its newly '

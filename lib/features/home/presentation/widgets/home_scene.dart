...
import 'package:tudlo/features/home/presentation/widgets/home_scene_layout.dart';
    ...
    return LayoutBuilder(
      builder: (context, viewport) {
        ...
        final lessonPanelHeight = HomeLessonPanel.designHeightForEnergy(
          ...
          configuredLessonCount:
              lessonPreviews.isEmpty ? 1 : lessonPreviews.length,
        );
      ...
      child: IgnorePointer(
        child: AnimatedBuilder(
          ...
          builder: (context, child) {
            ...
            final progress =
                ((scrollOffset - revealStart) / revealRange).clamp(0.0, 1.0);
            return Opacity(

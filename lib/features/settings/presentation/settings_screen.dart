          ...
          child: Column(
            ...
            children: [
              InkWell(
                ...
                highlightColor: const Color(0xFF448759).withValues(
                  alpha: 0.06,
                ),
                child: const Padding(
          ...
          child: Column(
            ...
            children: [
              InkWell(
                onTap: _toggleExpanded,
                splashFactory: NoSplash.splashFactory,
                highlightColor: const Color(0xFFAD6B30).withValues(
                  alpha: 0.06,
                ),
                child: const Padding(
                  padding: EdgeInsets.symmetric(vertical: 11, horizontal: 16),
        ...
        Row(
          children: [
            ...
            Text(
              ...
              style: TextStyle(
                color:
                    enabled ? const Color(0xFF568E4F) : const Color(0xFF63704F),
                fontFamily: 'ComicRelief',
                fontSize: 12,
                fontWeight: FontWeight.w700,
              ),
...
class _LearningEnergyPanelState extends State<_LearningEnergyPanel> {
  ...
  Future<void> _changeEnergy() async {
    ...
    final newEnergy = await showDialog<int>(
      context: context,
      builder: (_) => _EnergyEditorDialog(
        initialEnergy: controller.profile?.energy ?? 60,
      ),
    );
            ...
            child: Column(
              ...
              children: [
                InkWell(
                  ...
                  splashFactory: NoSplash.splashFactory,
                  highlightColor: const Color(0xFF609347).withValues(
                    alpha: 0.06,
                  ),
                  child: Padding(
  ...
  Widget _buildExpandedContent() {
    ...
    final remindersEnabled = profile?.settings.lessonRemindersEnabled ??
              ...
              TextField(
                ...
                decoration: InputDecoration(
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide:
                        const BorderSide(color: _pearlShadow, width: 1.5),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12),
                    borderSide:
                        const BorderSide(color: _tintGreenDepth, width: 1.5),
                  ),
                ),
          ...
          child: Column(
            ...
            children: [
              InkWell(
                onTap: _toggleExpanded,
                splashFactory: NoSplash.splashFactory,
                highlightColor: const Color(0xFF548E9E).withValues(
                  alpha: 0.06,
                ),
                child: const Padding(
                  padding: EdgeInsets.symmetric(vertical: 11, horizontal: 16),

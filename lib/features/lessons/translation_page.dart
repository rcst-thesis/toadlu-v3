...
class _TranslationPageState extends State<TranslationPage> {
  ...
  _TranslationResult _translate(String value) {
    ...
    final hilScore = _score(clean, hiligaynonToEnglish);
    final engScore = _score(clean, englishToHiligaynon);
    final fromHil = hilScore >= engScore;
    final dictionary = fromHil ? hiligaynonToEnglish : englishToHiligaynon;

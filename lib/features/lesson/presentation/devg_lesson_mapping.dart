...
class DevGLessonMapping {
  ...
  static int sourceLevelFor(LessonDefinition lesson) => switch (
    (lesson.grade, lesson.unit, lesson.lesson)
  ) {
    ...
    _ => throw ArgumentError.value(lesson.id, 'lesson', 'Unsupported DevG flow'),
  };

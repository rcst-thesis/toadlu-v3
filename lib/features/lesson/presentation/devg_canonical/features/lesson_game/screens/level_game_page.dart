...
import 'package:tudlo/features/lesson/presentation/devg_canonical/core/services/lesson_number_voice_service.dart';
...
import 'package:tudlo/features/lesson/presentation/devg_canonical/core/widgets/lesson_asset_glow.dart';
import 'package:tudlo/features/lesson/presentation/devg_canonical/core/widgets/mascot_widget.dart';
import 'package:tudlo/features/lesson/presentation/devg_canonical/data/dictionary/dictionary_data.dart';
...
class _GradeThreeSchoolMapThenLessonFlow extends StatefulWidget {
  ...
  const _GradeThreeSchoolMapThenLessonFlow({
...
class _LevelGamePageState extends State<LevelGamePage> {
  ...
  bool _claimRewardsOnce() {
    ...
    // This is the one handoff from preserved DevG mechanics to Tudlo progress.
    // It happens only after the learner claims the source reward UI.
    unawaited(
  ...
  Future<void> _returnToMapAfterPortraitRestore() async {
    ...
    // The source page is only valid below a DevGLessonHostScope. Preserve a
    // safe standalone fallback without reviving DevG's navigation shell.
                                                                                      ...
                                                                                      : gradeThreeMarketNumbersLesson
                                                                                          ...
                                                                                          : gradeThreeShoppingLesson
                                                                                              ? _GradeThreeShoppingFlow(
                                                                                                  onExit: _showPauseMenu,
                                                                                                  rewardStickerAsset: _activeLessonStickerAsset(),
                                                                                                  onBackToMap: _returnToMapAfterPortraitRestore,
                                                                                                  onContinue: _completeGradeThreeLesson,
                                                                                                )
                                                                                              : gradeThreeLesson && levelContent.unitNumber == 2 && levelContent.lessonNumber == 1
                                                                                                  ...
                                                                                                  : gradeThreeLesson && levelContent.unitNumber == 2 && levelContent.lessonNumber == 2
                                                                                                      ? _GradeThreeSchoolMapThenLessonFlow(
                                                                                                          onLessonComplete: _completeGradeThreeLesson,
                                                                                                        )
                                                                                                      : gradeThreeLesson

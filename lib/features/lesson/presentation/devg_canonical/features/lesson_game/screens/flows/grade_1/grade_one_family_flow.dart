  ...
  Widget build(BuildContext context) {
    ...
    return _LessonOneChrome(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const _LessonOneMessageCard(message: 'Ipares ang mga ngalan.'),
    ...
    return _LessonOneChrome(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Spacer(),
            const _LessonOneMessageCard(message: 'Nagtipon ang pamilya sa picnic!'),
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const Spacer(),
            const Spacer(),
            const _LessonOneMessageCard(message: 'Kilalahon ta sila.'),
      ...
      child: Stack(
        children: [
          ...
          Positioned(
            ...
            right: view.width * .06,
            bottom: view.height * .14,
            child: const _LessonOneMessageCard(message: 'Husto! Nanay kag tatay.'),
          ),
          Positioned(
            left: view.width * .06,
            right: view.width * .06,
  ...
  Widget build(BuildContext context) {
    ...
    return _LessonOneChrome(
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            const _LessonOneMessageCard(message: 'Ibutang sila sa ila nga lugar.'),

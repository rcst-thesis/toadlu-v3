    ...
    return _LessonOneChrome(
      ...
      child: Stack(
        children: [
          Positioned(
            left: -view.width * .08,
            top: top + view.height * .26,
            child: _LessonKokaMascot(
              size: (view.width * .47).clamp(170.0, 255.0),
              mood: KokaMood.idle,
            ),
          ),
          Positioned(
...
class _StickerUnlockRewardContentState
  ...
  Widget build(BuildContext context) {
    ...
    final requestedStickerWidth = (landscapeSticker
    ...
    final stickerTop = (view.height - stickerHeight) / 2 +
    ...
    return Stack(
      children: [
        ...
        Positioned(
          left: view.width * .08,
          right: view.width * .08,
          top: widget.messageStickerGap == null
              ? view.height * .13
              : null,

...
class _GradeThreeBantayFlowState extends State<GradeThreeBantayFlow>
  ...
  Future<void> _speak(List<(String, String)> lines) async {
    ...
    try {
      for (final line in lines) {
        ...
        final marketDialogueClip =
            _marketDialogueText(line.$1) == null ? null : line.$1;
  ...
  Widget _grayEvent(String id) => Opacity(
        ...
        child: ColorFiltered(
          colorFilter:
              const ColorFilter.mode(Color(0xFFA8A8A8), BlendMode.srcIn),
  ...
  List<Widget> _scene() {
    ...
    if (map) {
      ...
      return [
        _prompt('Ginapangita ang $active sa mapa...'),
      ];
    }
                          ...
                          size: _stage == _BantayStage.house
                              ...
                              : _stage == _BantayStage.farm
                                  ...
                                  : _stage == _BantayStage.market
                                      ? 270
                                      : 300,
                          mood: _stage == _BantayStage.house ||
                                  _stage == _BantayStage.farm
                              ? KokaMood.curious
                              : KokaMood.idle,
                        ),

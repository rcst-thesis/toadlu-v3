...
class AppData {
  ...
  static const _units = <GradeLevel, List<AppUnit>>{
    GradeLevel.grade1: [
      AppUnit(number: 1, startLevel: 1, lessonCount: 9, title: 'ALPHABETO KAG NUMERO'),
      AppUnit(number: 2, startLevel: 10, lessonCount: 4, title: 'MIYEMBRO SANG PAMILYA'),
      AppUnit(number: 3, startLevel: 14, lessonCount: 4, title: 'MGA COMMUNITY'),
      AppUnit(number: 4, startLevel: 18, lessonCount: 4, title: 'MGA SAPAT SA PALIBOT'),
      AppUnit(number: 5, startLevel: 22, lessonCount: 4, title: 'MGA LUGAR SA PALIBOT'),
    ],
    GradeLevel.grade2: [
      AppUnit(number: 1, startLevel: 1, lessonCount: 3, title: 'PAGPAKILALA'),
      AppUnit(number: 2, startLevel: 4, lessonCount: 3, title: 'GREETINGS AND POLITE'),
      AppUnit(number: 3, startLevel: 7, lessonCount: 3, title: 'PANGALAN'),
      AppUnit(number: 4, startLevel: 10, lessonCount: 3, title: 'SONGS AND RIDDLES'),

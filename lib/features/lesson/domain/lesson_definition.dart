...
class LessonCatalog {
  ...
  static const all = <LessonDefinition>[
    LessonDefinition(
      ...
      unit: 1,
      lesson: 1,
      title: 'Ang Nadula nga mga Letra ni Koka',
    ...
    LessonDefinition(
      ...
      unit: 1,
      lesson: 7,
      title: 'Ang Lima ka Tikang Pakadto sa Payong',
      location: MapLocation.school,
    ...
    LessonDefinition(
      ...
      unit: 2,
      lesson: 1,
      title: 'Ang Litrato sang Pamilya',
  ...
  static List<LessonDefinition> forLocation({
    ...
    required MapLocation location,
      ...
      forGrade(grade)
          .where((definition) => definition.location == location)
          .toList();
